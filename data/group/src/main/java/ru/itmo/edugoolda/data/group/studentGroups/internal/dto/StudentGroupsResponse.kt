...
@Serializable
internal class StudentGroupsResponse(
    @SerialName("groups") val groups: List<StudentGroupInfoDTO>,
    @SerialName("total") val total: Int
)

internal fun StudentGroupsResponse.toDomain(): StudentsGroupWithTotal = StudentsGroupWithTotal(
    groups = groups.map { it.toDomain() },
    total = total,
)

@Serializable
internal data class StudentGroupInfoDTO(
...
internal fun StudentGroupInfoDTO.toDomain(): StudentGroupInfo = StudentGroupInfo(
