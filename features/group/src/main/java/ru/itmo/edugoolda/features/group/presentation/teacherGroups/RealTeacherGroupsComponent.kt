...
class RealTeacherGroupsComponent(
    componentContext: ComponentContext,
    private val communication: TeacherGroupsComponent.Communication,
    private val errorHandler: ErrorHandler,
    private val groupListRepository: GroupListRepository,
) : TeacherGroupsComponent, ComponentContext by componentContext {
